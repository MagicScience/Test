...
public class SlotGoldOven extends Slot
{
	/** The player that is using the GUI where this slot resides. */
	private EntityPlayer thePlayer;
	private int field_75228_b;
	public SlotGoldOven(EntityPlayer par1EntityPlayer, IInventory par2IInventory, int par3, int par4, int par5)
	{
	...
	protected void onCrafting(ItemStack par1ItemStack)
	{
		...
		if (!this.thePlayer.worldObj.isRemote)
		{
			...
			float var3 = RecipesGoldOven.smelting().getExperience(par1ItemStack.itemID);
			int var4;
			if (var3 == 0.0F)
			{
				var2 = 0;
